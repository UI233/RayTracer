...
__global__ void HDRKernel(cudaSurfaceObject_t surface, cudaSurfaceObject_t surface_tmp, int width_per_thread, int height_per_thread, int width_per_block, int height_per_block,  float *Ymax)
{
...
//Incompleted
//
__global__ void filterKernel(cudaSurfaceObject_t surface_tmp, int width_per_thread, int height_per_thread, int width_per_block, int height_per_block, int width, int height)
{
    int stx = blockIdx.x * width_per_block + threadIdx.x * width_per_thread;
    int sty = blockIdx.y * height_per_block + threadIdx.y * height_per_thread;
